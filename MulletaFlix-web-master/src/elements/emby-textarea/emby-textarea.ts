...
function calculateOffset(textarea: HTMLTextAreaElement): number {
    const style = window.getComputedStyle(textarea, null);
    const props = ['paddingTop', 'paddingBottom'] as const;
    let offset = 0;
...
if (Object.getOwnPropertyDescriptor && Object.defineProperty) {
    ...
    if (descriptor?.configurable) {
        ...
        descriptor.set = function (this: HTMLTextAreaElement, value: string) {
...
EmbyTextAreaPrototype.createdCallback = function (): void {
    if (!this.id) {
...
EmbyTextAreaPrototype.attachedCallback = function (): void {
    ...
    const parentNode = this.parentNode as Node;
    ...
    this.label = function (text: string): void {
