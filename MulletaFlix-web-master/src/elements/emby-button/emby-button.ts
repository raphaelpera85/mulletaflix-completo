...
function onAnchorClick(this: HTMLAnchorElement, e: Event): void {
...
EmbyButtonPrototype.createdCallback = function (): void {
...
EmbyButtonPrototype.attachedCallback = function (): void {
    if (this.tagName === 'A') {
...
EmbyButtonPrototype.detachedCallback = function (): void {
    removeEventListener(this, 'click', onAnchorClick, {});
};
