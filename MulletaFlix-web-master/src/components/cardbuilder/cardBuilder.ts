 ...
 */
export function getCardsHtml(items: any[], options: any): string;
export function getCardsHtml(options: any): string;
export function getCardsHtml(items: any, options?: any): string {
 ...
 */
function getImageWidth(shape: any, screenWidth: any, isOrientationLandscape: any) {
 ...
 */
export function setCardData(items: any, options: any) {
 ...
 */
function buildCardsHtmlInternal(items: any, options: any) {
    ...
    for (const [i, item] of items.entries()) {
        ...
        if (options.indexBy) {
            ...
            if (options.indexBy === 'PremiereDate') {
                ...
                newIndexValue = item.CommunityRating ? (Math.floor(item.CommunityRating) + roundedRatingDecimal) + '+' : '';
            }
 ...
 */
function getCardTextLines(lines: any, cssClass: any, forceLines: any, isOuterFooter: any, cardLayout: any, addRightMargin: any, maxLines: any) {
    let html = '';
 ...
 */
function getAirTimeText(item: any, showAirDateTime: any, showAirEndTime: any) {
    let airTimeText = '';
 ...
 */
function getCardFooterText(item: any, apiClient: any, options: any, footerClass: any, progressHtml: any, flags: any, urls: any) {
    ...
    if (showOtherText) {
        ...
        if (options.showYear || options.showSeriesYear) {
            const productionYear = item.ProductionYear ? item.ProductionYear.toString() : '';
            if (item.Type === 'Series') {
 ...
 */
function getTextActionButton(item: any, text?: any, serverId?: any): string {
    if (!text) {
 ...
 */
function getItemCountsHtml(options: any, item: any) {
    const counts = [];
    let childText;
    ...
    if (item.Type === 'Playlist') {
        ...
        if (item.RunTimeTicks) {
            ...
            childText += globalize.translate('ValueMinutes', String(Math.round(minutes)));
        } else {
...
let refreshIndicatorLoaded: boolean | undefined;
 ...
 */
function buildCard(index: any, item: any, apiClient: any, options: any) {
 ...
 */
function getHoverMenuHtml(item: any, action: any) {
    let html = '';
 ...
 * @returns {string} HTML markup of the card overlay.
 */
export function getDefaultText(item: any, options: any) {
    let icon;
 ...
 */
export function buildCards(items: any, options: any) {
 ...
 */
function ensureIndicators(card: any, indicatorsElem?: any) {
    if (indicatorsElem) {
 ...
 */
function updateUserData(card: any, userData: any) {
 ...
 */
export function onUserDataChanged(userData: any, scope: any) {
 ...
 */
export function onTimerCreated(programId: any, newTimerId: any, itemsContainer: any) {
 ...
 * @param {HTMLElement} itemsContainer - DOM element of the itemsContainer.
 */
export function onTimerCancelled(timerId: any, itemsContainer: any) {
 ...
 * @param {HTMLElement} itemsContainer - DOM element of the itemsContainer.
 */
export function onSeriesTimerCancelled(cancelledTimerId: any, itemsContainer: any) {
