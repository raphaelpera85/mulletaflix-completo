...
function getTextStyles(settings: SubtitleAppearanceSettings, preview: boolean): TextStyleItem[] {
    const list: TextStyleItem[] = [];
...
function getWindowStyles(settings: SubtitleAppearanceSettings, preview: boolean): TextStyleItem[] {
    const list: TextStyleItem[] = [];
...
export function getStyles(settings: SubtitleAppearanceSettings, preview: boolean): { text: TextStyleItem[]; window: TextStyleItem[] } {
    return {
...
function applyStyleList(styles: TextStyleItem[], elem: HTMLElement): void {
...
export function applyStyles(elements: AppearanceElements, appearanceSettings: SubtitleAppearanceSettings): void {
