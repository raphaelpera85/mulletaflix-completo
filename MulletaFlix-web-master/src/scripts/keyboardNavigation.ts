 ...
 */
const NavigationKeys: string[] = ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'BrowserHome', 'Find'];

/**
 * Keys used for media playback control.
 */
const MediaKeys: string[] = ['MediaRewind', 'MediaStop', 'MediaPlay', 'MediaFastForward', 'MediaTrackPrevious', 'MediaTrackNext', 'MediaPlayPause'];

/**
 * Elements for which navigation should be constrained.
 */
const InteractiveElements: string[] = ['INPUT', 'TEXTAREA'];

/**
 * Types of INPUT element for which navigation shouldn't be constrained.
 */
const NonInteractiveInputElements: string[] = ['button', 'checkbox', 'color', 'file', 'hidden', 'image', 'radio', 'reset', 'submit'];
 ...
 */
export function isInteractiveElement(element: Element | null | undefined): boolean {
...
export function canEnableGamepad(): boolean {
    // Not needed for UWP
...
if (typeof navigator.getGamepads === 'function' && appSettings.enableGamepad() && canEnableGamepad()) {
