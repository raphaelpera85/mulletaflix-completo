const e=`\uFEFF<div id="wizardStartPage" data-role="page" class="page standalonePage wizardPage" data-backbutton="false">
        ...
        <div class="ui-corner-all ui-shadow wizardContent" style="position:relative;">
            <form class="wizardStartForm">
                <div>
                    ...
                    <a is="emby-linkbutton" rel="noopener noreferrer" href="https://MulletaFlix.org/docs/general/post-install/setup-wizard/" target="_blank" class="raised raised-alt" style="float:right;margin-top:20px;">
