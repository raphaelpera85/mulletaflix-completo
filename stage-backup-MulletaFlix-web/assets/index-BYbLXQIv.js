const n=`<div id="loginPage" data-role="page" class="page standalonePage backdropPage" data-backbutton="false" data-backdroptype="splashscreen">
    <div class="padded-left padded-right padded-bottom-page margin-auto-y">
        <div class="loginBranding">
            <img class="loginBrandLogo" src="/web/assets/branding/icon.png" alt="MulletaFlix" />
            <div class="loginBrandName" aria-label="MulletaFlix">
                <span class="loginBrandNameMulleta">Mulleta</span><span class="loginBrandNameFlix">Flix</span>
            </div>
        </div>

        <div class="loginActionCard margin-auto-x">
            <form class="manualLoginForm hide">
                <div class="padded-left padded-right flex align-items-center justify-content-center">
                </div>
                <div class="inputContainer">
                    <input is="emby-input" type="text" id="txtManualName" required="required" label="E-mail" autocomplete="username" autocapitalize="off" />
                    <div class="loginManualHint">Você pode entrar com nome de usuário ou e-mail, conforme o cadastro.</div>
                </div>
            ...
            <div class="readOnlyContent">
                ...
                <button is="emby-button" type="button" class="raised block btnRegister">
                    <span>\${ButtonRegister}</span>
                </button>
